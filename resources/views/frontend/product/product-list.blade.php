...
<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('{{ asset('dist/img/sli3.jpg') }}');">
    <h2 class="ltext-105 cl0 txt-center" style="color:#FF0000 ;">
